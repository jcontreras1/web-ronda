<div class="modal" id="mdl_retiro_edit" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<form method="POST" id="form_retiro_edit">
			@method('PATCH')
			@csrf
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Modificar Retiro</h5>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-12">
							...
							<input type="time" class="form-control" name="hora" required id="form_retiro_edit_hora">
						</div>
						<div class="col-12">
							<label>Monto @include('components.misc.required')</label>
							<input type="number" step="0.01" class="primerCampo form-control" name="monto" required id="form_retiro_edit_monto">
						</div>						
						<div class="col-12">
							<label>Observaciones @include('components.misc.required')</label>
							<input type="text" placeholder="Ej: Venta de souvenir" autocomplete="off" class="form-control" name="observaciones" required id="form_retiro_edit_observaciones">
						</div>
						<div class="col-12">
							<label>Medio de Pago @include('components.misc.required')</label>
							<select class="form-select" name="medio_pago_id" required id="form_retiro_edit_medio_pago">
						...
						<div class="col-12">
							...
							<select class="form-select" name="moneda_id" required id="form_retiro_edit_moneda">
