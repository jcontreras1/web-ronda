<div class="modal" id="mdl_retiro_create" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<form method="POST" action="{{route('retiro.store')}}">
			@csrf
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title">Retiro</h5>
				...
				<div class="modal-body">
					<div class="row">
						<div class="col-12">
							...
							<input type="time" value="{{date('H:i')}}" class="form-control" name="hora" required>
						</div>
						<div class="col-12">
							<label>Monto @include('components.misc.required')</label>
							<input type="number" step="0.01" class="primerCampo form-control" name="monto" required>
						</div>
						<div class="col-12">
							<label>Observaciones @include('components.misc.required')</label>
							<input type="text" placeholder="Ej: Retiro para combustible" autocomplete="off" class="form-control" name="observaciones" required>
						</div>
						<div class="col-12">
							<label>Medio de Pago @include('components.misc.required')</label>
							<select class="form-select" name="medio_pago_id" required>
