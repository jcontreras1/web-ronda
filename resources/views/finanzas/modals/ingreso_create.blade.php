<div class="modal" id="mdl_ingreso_create" tabindex="-1" role="dialog">
				...
				<div class="modal-body">
					<div class="row">
						...
						<div class="col-12">
							...
							<input type="text" placeholder="Ej: Venta de souvenir" autocomplete="off" class="form-control" name="observaciones" required>
						</div>
						<div class="col-12">
